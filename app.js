...
function checkPassword() {
  ...
  if (password === correctPassword) {
    ...
    document.querySelector('.container').style.display = 'block';    // Show video call container
  } else {
    document.getElementById('loginError').textContent = 'Incorrect password'; // Show error message
  }
}
...
const shareBtn = document.getElementById('shareBtn');  // Correcting here
